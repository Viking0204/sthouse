...
def ptb_producer(raw_data, batch_size, num_steps, name=None):
    with tf.name_scope(name, "PTBProducer", [raw_data, batch_size, num_steps]):
        ...
        weight_data = tf.convert_to_tensor(weight_data, name="weight_data", dtype=tf.float32)
        ...
        z = tf.strided_slice(weight_data, [i * batch_size, 0],[(i+1) * batch_size, num_steps])
